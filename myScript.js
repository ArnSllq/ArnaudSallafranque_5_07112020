...
//                 tedContain.innerHTML+='<div class="col-lg-4"><a class="" href=produit.html?id="'+response[i]._id+'"><img class="img-fluid" src="'+response[i].imageUrl+'" alt="'+response[i].name+'"><p>'+response[i].name+'</p><button type="button" class="btn btn-outline-warning">Plus d\'informations</button></a></div>';
//             }
//     }
// };
